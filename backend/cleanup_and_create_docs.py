...
print(f'\n총 {len(applicants)}명의 지원자에 대한 문서를 생성합니다...')
...
"""
    ...
    try:
        ...
        resume_doc = {
            ...
            "summary": f"{name}의 {position} 이력서입니다.",
            "keywords": skills,
            ...
            "file_metadata": {
                "filename": f"{name}_이력서.txt",
                "size": len(resume_content.encode('utf-8')),
                "mime": "text/plain",
                "hash": f"hash_{name}_{random.randint(1000, 9999)}",
