...
=======
        `${projectsText}\n\n\n` +
                 `전반적 평가 및 지원 직무 적합성\n` +
         `이력서의 기본 구조와 내용이 체계적으로 잘 정리되어 있으며, 지원 직무에 대한 명확한 이해를 보여주고 있습니다. 학력, 전공, 경력, 기술 등 각 요소가 적절한 균형을 이루고 있어 전반적인 적합성을 갖추고 있습니다. 일부 세부 경험이나 성과 정보에서 보완이 필요하지만, 기본적인 역량과 잠재력은 충분히 인정할 수 있습니다.\n\n\n` +
         `경험 및 역량 균형과 개선 방향\n` +
         `하드 스킬과 소프트 스킬의 기본적인 균형을 보여주며, 프로젝트 경험과 실무 경력의 기반을 잘 갖추고 있습니다. 기술적 전문성과 실무 경험의 조화를 위한 추가적인 경험 축적이 필요하지만, 현재 수준에서도 충분한 성장 가능성을 보여줍니다. 이력서 작성 능력과 자기 표현력이 우수하며, 체계적인 사고와 논리적 구성 능력을 갖추고 있어 향후 발전 가능성이 높습니다.\n\n\n` +
         `종합 평가 의견\n` +
         `이력서 분석 결과를 종합적으로 평가한 결과, 지원자의 기본적인 역량과 잠재력은 충분히 인정할 수 있습니다. 학력, 경력, 기술 등 각 영역에서 적절한 수준의 역량을 보여주고 있으며, 지원 직무와의 연관성도 양호한 수준입니다. 일부 세부 경험이나 성과 정보에서 보완이 필요하지만, 전반적으로는 체계적이고 전문적인 이력서를 작성한 것으로 평가됩니다.`;
>>>>>>> Stashed changes
    }
...
=======
      analysis += `전반적으로 매우 우수한 수준이지만, 최신 기술 트렌드에 대한 이해도나 특정 분야에서의 심화 전문성 강화가 있다면 더욱 완벽한 이력서가 될 것입니다. 현재 수준에서도 충분히 경쟁력 있는 지원자이며, 지속적인 발전 가능성이 높습니다. 이력서 작성 능력과 자기 표현력이 뛰어나며, 체계적인 사고와 논리적 구성 능력을 갖추고 있습니다.\n\n\n`;
>>>>>>> Stashed changes
    } else if (avgScore >= 70) {
